...
public class Giraffe extends Mammal implements RunningAnimal, BirthGivingAnimal, HerbivorousAnimal {
	...
	public Giraffe(WildParkAreaCell wildParkAreaCell,
			boolean isNewborn) {
	...
	public Giraffe() {
		this( animalSpeciesSpecification, GiraffeSpeciesSpecification.selectRandomCell(), false);
	}

	public Giraffe( AnimalSpeciesSpecification animalSpeciesSpecification, WildParkAreaCell wildParkAreaCell, boolean isNewborn ) {
		super( animalSpeciesSpecification, wildParkAreaCell, isNewborn );
	}
